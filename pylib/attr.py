...
class attr(Mapping):
    ...
    def _valid_name(cls, key):
         ...
         * The key doesn't overlap with any class attributes (for Attr,
            ...
            'register').
        """
        return isinstance(key, str) and re.match('^[A-Za-z][A-Za-z0-9_]*$', key) and not hasattr(cls, key)


# noinspection PyPep8Naming
class mutable_attr(attr, MutableMapping):
    """
    A mixin class for a mapping that allows for attribute-style access
    of values.
    """
    ...
    def _setattr(self, key, value):
        ...
        """
        super(mutable_attr, self).__setattr__(key, value)
    ...
    def __setattr__(self, key, value):
        ...
        if self._valid_name(key):
            ...
            raise TypeError("'{}' does not allow attribute creation.".format(self.__class__.__name__))
    ...
    def _delattr(self, key):
        ...
        """
        super(mutable_attr, self).__delattr__(key)
    ...
    def __delattr__(self, key, force=False):
        ...
        if self._valid_name(key):
            ...
            raise TypeError("'{}' does not allow attribute deletion.".format(self.__class__.__name__))
